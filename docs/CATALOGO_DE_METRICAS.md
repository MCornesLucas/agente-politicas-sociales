...
| Proyección | Situaciones que atendería el sistema, 2025-2027 | Predictiva | Sobre la métrica 1 (12 puntos) — calculada; el dato real 2025 (9.178) quedó dentro del rango proyectado 8.500-10.300 | ✅ calculada |
| Proyección | Inclusión de la familia proyectada | Predictiva | Sobre la métrica 10 (11 puntos, 2014-2024) — calculada (2027: ~50%, 42-58); el dato 2025 no es comparable por el cambio de base de la fuente | ✅ calculada |
